...
('2021/2022','2021-10-28','2022-7-16');
 ...
 values 
('IAI_160','BELINGA','Rostelle'),
('IAI_161','IPEM','ARLETTE'),
('IAI_162','MEMBOU','WILSON'),
('IAI_163','ABANDA','Narcis'),
('IAI_164','MEKWONTCHOU','Albert'),
('IAI_165','CHATCHUIN DJOKO','Dassy'),
('IAI_166','TCHAKOUTIO','Ludovic'),
('IAI_167','TOGNA','Valerie'),
('IAI_168','MAVOUNGOU','Jean'),
('IAI_169','DONGMO','Bertin'),
('IAI_170','NDJATHE','Germaine'),
('IAI_171','SALABESSIES','Pacôme ignasse');
...
(2,"UML",40),
(3,"CONCEPTION BD.",30),
(4,"IMPLEMENTATION BD.",30),
(5,"PROBABILITE STAT.",40),
(6,"ALGEBRE LINEAIRE",40),
(7,"CRYPTOGRAPHIE",30),
(8,"SECURITE INFO.",30),
(9,"PWEB 2",40),
(10,"P.O.O",40),
(11,"TIC ET MANAGMENT",35),
(12,"RECHERCHE OPERATIONNELLE",20),
(13,"SPORT",10),
(14,"SEMINAIRE THEMATIQUE",20),
(15,"DROIT DES TIC",35),
(16,"CLOUD COMPUTING",30);
...
values
('Mat109','ATEBA NDJEMBA','JOSEPH','2000-09-20','M'),
('Mat110','ENOTO','ANDRE BENOIT ','2001-03-03','M'),
('Mat111', 'DIPITA', 'ANGE', '1994-04-22', 'M'),
('Mat112', 'ESSAM',  'EMMANUEL', '1998-03-14', 'M'),
('Mat113', 'GHOMFO', 'ODETTE', '1994-12-17', 'F'),
('Mat114', 'MANNOUCK ADONG','DENISE', '1996-11-02', 'F'),
('Mat115', 'NGUE MANGUELE',   'LIONNEL', '2000-12-07', 'M'),
('Mat116', 'YERIMA',  'JEAN',  '1995-12-02', 'M'),
('Mat117', 'SYLVAIN KANKO ELAME',  'MIGUEL',  '2002-02-28', 'M'),
('Mat118', 'NOADJE',  'DAVID',  '1996-01-14', 'M'),
('Mat119', 'SIKATI KENMOGNE',  'SAMUEL',  '2002-02-19', 'M'); 
